...
解决vue路由history模式, 无法直接访问某个页面的问题, 路由需要配置全局守卫
...
public class WebSocket {
    ...
    public void serviceSendMessage(String message) {
        try {
...
public class WebSocketService{
    ...
    public void method(){
        ...
        jsonObject.put("event", "text");
        webSocket.serviceSendMessage(jsonObject.toJSONString());
